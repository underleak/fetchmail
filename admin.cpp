...
void Admin::slotFullBackUp()
{
    ...
    char* systemQuery2 = "/usr/local/mysql-8.0.21-macos10.15-x86_64/bin/mysqldump -uroot -p20643579 testdb --xml > ";
...
{
    char* systemQuery = "/usr/local/mysql-8.0.21-macos10.15-x86_64/bin/mysqldump  -uroot -p20643579  --no-data testdb > ";
    QTime time = QTime::currentTime();
    QString tmpTime = time.toString();
    QString path = on_backUp_clicked();
    ...
    char* systemQuery2 = "/usr/local/mysql-8.0.21-macos10.15-x86_64/bin/mysqldump  -uroot -p20643579  --no-data testdb --xml > ";
    QTime time2 = QTime::currentTime();
    QString tmpTime2 = time2.toString();
